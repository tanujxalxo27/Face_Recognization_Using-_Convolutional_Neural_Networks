...
classifier = cv2.CascadeClassifier(r"C:\Users\Admin\Desktop\Project\FaceRecognization\haarcascade_frontalface_default.xml")

model = load_model(r"C:\Users\Admin\Desktop\Project\FaceRecognization\FINAL_MODEL.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['JayK', 'Soham', 'Tanuj Manupreet', 'cutie', 'mahesh', 'pratyasha']
    return labels[pred]
